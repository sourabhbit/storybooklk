...
export const LineFlex = styled.div<{
	vertical?: boolean
	hide?: boolean
	align?: 'flex-end' | 'flex-start' | 'center' | 'normal'
	...
	// flex-wrap: wrap;
`
export const VerticalGap = styled.hr<{
	cardType: ProductCardTypesENUM
}>`
	/* display: flex; */
	width: 100%;
	border: 0.1px solid var(--whitish-gray);
...
export const PurchaseBar = styled.div`
	width: 360px;
	height: 87px;
	padding: var(--pd-20) var(--pd-12);
	border-top: 1px solid ${colorPalette.darkBlue100};
	background-color: var(--white);
`

export const BoughtNo = styled.div`
	font-size: var(--fs-10);
	color: #999;
`
export const TryOn = styled.div`
	border: 1px solid black;
	border-radius: 8px;
	padding: 0px var(--pd-12) 0px var(--pd-12);
	display: flex;
	height: 34px;
	align-items: center;
	font-size: var(--fs-12);
...
export const TryOnImage = styled.img`
	width: 36px;
	margin-top: 1px;
	margin-right: -7px;
`
